...
const routes: Routes = [{
  ...
  children: [
    ...
    {
      path: 'mesas',
      loadChildren: () => import('./voter-tables/voter-tables.module')
      .then(m => m.VoterTablesModule)
    },
    {
      path: 'partidos',
      loadChildren: () => import('./political-parties/political-parties.module')
      .then(m => m.PoliticalPartiesModule)
    },
    {
      path:'candidatos',
